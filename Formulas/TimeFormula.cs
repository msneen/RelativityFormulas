...
namespace RelativityFormulas.Formulas
{
    public static class TimeFormula
    {
        ...
        public static MassBody CalculateTimeDilation(this MassBody massBody1, MassBody massBody2, double additionalDistanceBeyondRadii)
        {
            var massDilation = massBody2 != null ? massBody1.GetTimeDilationFactorDueToMass(massBody2, additionalDistanceBeyondRadii) : 0;
        ...
        public static double GetTimeDilationFactorDueToMass(this MassBody massBody1, MassBody massBody2, double additionalDistanceBeyondRadii)
        {
            var unDilatedTime = 1;
            var velocityMetersPerSecondSquared = massBody1.CalculateWeightForce(massBody2, additionalDistanceBeyondRadii).WeightForce;//This needs to be the velocity at that point in space, or on the surface.
        ...
        /// <returns></returns>
        private static double GetTimeDilationFactorDueToVelocity(double velocity)
        {
